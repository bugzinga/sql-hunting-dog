...
namespace DatabaseObjectSearcher
{
    ...
    public class ManagementStudioController
    {
        ...
        {
            var dependentCmd = String.Format("EXEC sp_MSdependencies N'{0}.{1}', null, 1315327", obj.Schema, obj.Name);
            var dependensOnCmd = String.Format("EXEC sp_MSdependencies N'{0}.{1}', null, 1053183", obj.Schema, obj.Name);
            ...
            var cntString = new SqlConnectionStringBuilder(connection.ConnectionString);
